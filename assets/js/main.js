(function ($) {
    ...
    $('.account_link').on('click', function () {
        $('.changepassword_link , .profile_link').toggleClass('d-none d-block')
        $('.account_link i').toggleClass('fa-plus fa-minus')
    })
    ...
    var $card_breaks_carousel = $('.car_breaks_carousel');
    ...
    var $form_check_slider = $('.form_check_slider');
    if ($form_check_slider.length > 0) {
        $form_check_slider.slick({
            vertical: true,
            verticalSwiping: true,
            slidesToShow: 5,
            slidesToScroll: 1,
            arrows: true,
            prevArrow: '<button class="slick-arrow slick-prev" type="button"><img src="assets/img/icon/up.png"></button>',
            nextArrow: '<button class="slick-arrow slick-next" type="button"><img src="assets/img/icon/down.jpg"></button>'
        });
    }
    var $car_breaks_slider = $('.car_breaks_slider');
    if ($car_breaks_slider.length > 0) {
        $car_breaks_slider.slick({
            vertical: true,
            verticalSwiping: true,
            slidesToShow: 4,
            slidesToScroll: 1,
    ...
    /*---specification navactive activation---*/
    var $specificationsProductNavactive = $('.spec_product_navactive');
    if ($specificationsProductNavactive.length > 0) {
        $('.spec_product_navactive').owlCarousel({
            loop: true,
            nav: true,
            autoplay: false,
            autoplayTimeout: 8000,
    ...
    $('.spec_product_navactive a').on('click', function (e) {
        e.preventDefault();

        var $href = $(this).attr('href');

        $('.spec_product_navactive a').removeClass('active');
        $(this).addClass('active');
